...
if (!content.includes('ledgerCustomer')) {
  content = content.replace('  const [editingCustomer, setEditingCustomer] = useState<any>(null);', stateCode + '\n  const [editingCustomer, setEditingCustomer] = useState<any>(null);');
}

// Inject Ledger Dialog safely
const dialogHtml = `
        {/* Ledger Dialog */}
...
if (!content.includes('Ledger Dialog')) {
  // Safe replace after Add Customer Dialog closes.
  content = content.replace('            </form>\r\n          </DialogContent>\r\n        </Dialog>\r\n      </div>', '            </form>\r\n          </DialogContent>\r\n        </Dialog>\r\n' + dialogHtml + '\r\n      </div>');
  content = content.replace('            </form>\n          </DialogContent>\n        </Dialog>\n      </div>', '            </form>\n          </DialogContent>\n        </Dialog>\n' + dialogHtml + '\n      </div>');
}

// Map the dropdown button
...
console.log('Customer UI completely fixed');
